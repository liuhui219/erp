...
// import { Divider, Card, Input, Badge, message } from "antd";  
...
// const namespace = "express_customer_copy";  
// @connect(state => ({  
//   model: state[namespace]  
// }))  
// export default class Customer extends CrudRoute {  
//   constructor(props) {  
//     super(props, namespace);  
//   }  
//   render() {  
//     const {  
//       model: { data: { content, pagination }, loading },  
//       dispatch  
//     } = this.props;  
//     const { modalVisible, modalType, currentDomain } = this.state;  
...
//             <a  
//               onClick={() => {  
//                 confirm(`确定要移除客户【${record.name}】吗？`, () => {  
//                   if (record.id === undefined) {  
//                     message.error("未能获取要删除的ID");  
//                     return;  
//                   }  
//                   this.doRemove(record.id);  
//                 });  
//               }}  
//             >  
//               删除  
...
//         itemProps: { label: "发货人姓名" },  
//         decoratorOptios: {  
//           rules: [  
//             { required: true, message: "发货人姓名不能为空" }  
...
//         itemProps: { label: "区域" },  
//         render: (item, formItem, form) => (  
//       <Cascader placeholder="请选择地区"   options={options}  
...
//             ]  
//         },  
//         render: () => <Input.TextArea rows={2} />  
//       },  
//       {  
//         name: "addressZipcode",  
//         itemProps: { label: "邮政编码" },  
//         decoratorOptios: {  
//           rules: [  
...
//       {  
//         name: "addressTel",  
//         itemProps: { label: "联系电话" },  
//         decoratorOptios: {  
//           rules: [  
  
//             { max: 200, message: "联系电话不能超过200个字符" }  
...
//       <PageHeaderLayout  
//         title="发货地址管理"  
//         breadcrumbList={[{ title: "首页" }, { title: "发货地址管理" }]}  
//       >  
//         <Card bordered={false}>  
//           <Filter  
//             searchAreaCol={12}  
...
//         </Card>  
//         {modalVisible &&  
//           (modalType === "create" || modalType === "modify") && (  
//             <FormModal  
//               title={`${modalType === "create" ? "创建" : "编辑"}客户信息`}  
