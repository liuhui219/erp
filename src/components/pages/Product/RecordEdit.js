...
class RecordEdit extends Component {
  ...
  componentDidMount(){
    ...
    mains = [];
    subData = [];
    var obj = {name:'产品档案修改',menuKey:'pro-record-edit/'+ this.props.match.params.id,key:'pro-record-edit'};
    ...
    fetch(globals.url.url+'/product/product/showById?id='+this.props.match.params.id, {
      ...
      if(result.code == 0){
        ...
        var combination = [];
          ...
          var skuCategorysx = JSON.parse(result.result.productSku.skuHead);
          that.setState({
            spinning:false,
            column:column,
            imageUrl:globals.url.url+'/common/file/download?key='+result.result.imgResourceKey,
            data:columnData,
            headResourceKey:result.result.imgResourceKey,
            skuCategorys:JSON.parse(result.result.productSku.skuHead),
            skuCategorys1:JSON.parse(result.result.productSku.skuHead),
            skuCategorysx:JSON.parse(JSON.stringify(skuCategorysx)).slice(3),
            stringCombination:combination,
            isShow:result.result.unitType,
            isGlPc:result.result.batchOption,
            isBzq:result.result.expirationDateOption,
            checkNick:result.result.productDateOption,
            mains:result.result
          })
          if(result.result.batchType == 1){
            that.setState({
              isShowAll:false,
            })
          }else if(result.result.batchType == 2){
            that.setState({
              isShowAll:true,
              isShowM:false,
            })
  ...
  add(index){
    ...
    mains = [];
    var alls = [];
    console.log(this.state.skuCategorysx)
    ...
    if(this.state.headResourceKey == ''){
      ...
      this.props.form.validateFields((err, values) => {
        if (!err) {
          ...
          if(values.batchType == '自定义'){
            values.batchType = 1;
          }
          if(values.batchType == '固定前缀+流水号'){
            values.batchType = 1;
          }


          that.state.proCategory.map((infos,x)=>{
            if(infos.name == values.categoryId){
              values.categoryId = infos.id
            }
          })

          that.state.proStockType.map((infos,x)=>{
            if(infos.stockType == values.stockTypeId){
              values.stockTypeId = infos.id
            }
          })

          that.state.expirationDate.map((infos,x)=>{
            if(infos.name == values.expirationDateId){
              values.expirationDateId = infos.id
            }
          })

          that.state.proUnit.map((infos,x)=>{
            if(infos.name == values.baseUnitId){
              values.baseUnitId = infos.id
            }
          })

          that.state.proUnit.map((infos,x)=>{
            if(infos.name == values.assistUnitId){
              values.assistUnitId = infos.id
            }
          })
          ...
          fetch(globals.url.url+'/product/product/update', {
            method: 'POST',
            credentials: 'include',
            headers: {
              'Content-Type': 'application/json'
            ...
            if(result.code == 0){
              ...
              that.props.history.push({pathname: '/erp/pro-Record-info/' + that.props.match.params.id});
              var obj = {name:'产品档案详情',menuKey:'pro-Record-info/'+ that.props.match.params.id,key:'pro-Record-info'};
              that.props.dispatch({ type: 'INCREMENT' ,text:obj});
              var objs = {menuKey:'pro-record-edit',key:'pro-record-edit'};
  ...
  close = (e) => {
    this.props.history.push({pathname: '/erp/pro-Record-info/' + this.props.match.params.id});
    var obj = {name:'产品档案详情',menuKey:'pro-Record-info/'+ this.props.match.params.id,key:'pro-Record-info'};
    this.props.dispatch({ type: 'INCREMENT' ,text:obj});
    var objs = {menuKey:'pro-record-edit',key:'pro-record-edit'};
                           ...
                           <div className="page_add_input_main_form" style={{width:'25%'}}>
                               ...
                               <FormItem
                                ...
                                >
                                  {getFieldDecorator('spuCode', {
                                    ...
                                    initialValue:this.state.mains.spuCode
                                  })(
                               ...
                               <FormItem
                                ...
                                >
                                  {getFieldDecorator('name', {
                                    ...
                                    initialValue:this.state.mains.name
                                  })(
                               ...
                               <FormItem
                                ...
                                {getFieldDecorator('categoryId', {
                                  ...
                                  initialValue:this.state.mains.categoryName
                                })(
                            ...
                            <div className="page_add_input_main_form" style={{width:'40%'}}>
                                <FormItem
                                 ...
                                 {getFieldDecorator('stockTypeId', {
                                   ...
                                   initialValue:this.state.mains.stockTypeName
                                 })(
                                ...
                                <FormItem
                                 ...
                                 >
                                     ...
                                     <Checkbox
                                        disabled
                                        checked={this.state.mains.canSales}
                                      >
                                ...
                                <FormItem
                                 ...
                                 {getFieldDecorator('transferGoodsType', {
                                   ...
                                   initialValue:this.state.mains.productSource
                                 })(
                                ...
                                <FormItem
                                 ...
                                 >
                                   {getFieldDecorator('shapeCode', {
                                     ...
                                     initialValue:this.state.mains.shapeCode
                                   })(
                                   ...
                                   <div className="ant-form-item-control-wrapper ant-col-xs-24 ant-col-sm-17" style={{display:'flex'}}>
                                     ...
                                     <FormItem
                                      ...
                                      {getFieldDecorator('expirationDateOption', {
                                        ...
                                        initialValue:this.state.mains.expirationDateOption
                                      })(
                                        <Checkbox
                                     ...
                                     {this.state.isBzq ? <FormItem
                                      ...
                                      {getFieldDecorator('expirationDateId', {
                                        ...
                                        initialValue:this.state.mains.expirationDateName
                                      })(
                            ...
                            <div className="page_add_input_main_form" style={{width:'35%'}}>
                                <FormItem
                                 ...
                                 {getFieldDecorator('baseUnitId', {
                                   ...
                                   initialValue:this.state.mains.baseUnit
                                 })(
                                ...
                                {this.state.isShow ? <FormItem
                                 ...
                                 {getFieldDecorator('assistUnitId', {
                                   ...
                                   initialValue:this.state.mains.assistUnit
                                 })(
                                   ...
                                   <div style={{display:'flex',justifyContent:'space-around'}}>
                                     ...
                                     <span style={{width:100}}>
                                       {getFieldDecorator('conversionRate', {
                                         ...
                                         initialValue:String(this.state.mains.conversionRate)
                                       })(
                             ...
                             <div className="ant-form-item-control-wrapper ant-col-xs-24 ant-col-sm-22" style={{display:'flex'}}>
                               ...
                               {this.state.isShowM ? <FormItem
                                ...
                                >
                                  {getFieldDecorator('batchPrefix', {
                                    ...
                                    initialValue:this.state.mains.batchPrefix
                                  })(
                               ...
                               <FormItem
                                ...
                                {getFieldDecorator('batchSerialnoNum', {
                                  ...
                                  initialValue:this.state.mains.batchSerialnoNum
                                })(
                         ...
                         <FormItem
                          ...
                          >
                            {getFieldDecorator('defaultSupplier', {
                              ...
                              initialValue:this.state.mains.defaultSupplier
                            })(
                         ...
                         <FormItem
                          ...
                          >
                            {getFieldDecorator('purchaseUtil', {
                              ...
                              initialValue:this.state.mains.purchaseUtil
                            })(
                         ...
                         <FormItem
                          ...
                          >
                            {getFieldDecorator('valuationUtil', {
                              ...
                              initialValue:this.state.mains.valuationUtil
                            })(
                         ...
                         <FormItem
                          ...
                          >
                            {getFieldDecorator('purchaseUpperLimit', {
                              ...
                              initialValue:this.state.mains.purchaseUpperLimit
                            })(
                         ...
                         <FormItem
                          ...
                          >
                            {getFieldDecorator('purchaseLowerLimit', {
                              ...
                              initialValue:this.state.mains.purchaseLowerLimit
                            })(
                         ...
                         >
                           {getFieldDecorator('salesUtil', {
                             rules: [{
                              ...
                              initialValue:this.state.mains.salesUtil
                           })(
                        ...
                        <FormItem
                         ...
                         >
                           {getFieldDecorator('salesUpperLimit', {
                             ...
                             initialValue:this.state.mains.salesUpperLimit
                        ...
                        <FormItem
                         ...
                         >
                           {getFieldDecorator('salesLowerLimit', {
                             ...
                             initialValue:this.state.mains.salesLowerLimit
                           })(
                        ...
                        <FormItem
                         ...
                         >
                           {getFieldDecorator('stockUtil', {
                             ...
                             initialValue:this.state.mains.stockUtil
                        ...
                        <FormItem
                         ...
                         >
                           {getFieldDecorator('minStock', {
                             ...
                             initialValue:this.state.mains.minStock
                        ...
                        <FormItem
                         ...
                         >
                           {getFieldDecorator('maxStock', {
                             ...
                             initialValue:this.state.mains.maxStock
                        ...
                        <FormItem
                         ...
                         >
                           {getFieldDecorator('safeStock', {
                             ...
                             initialValue:this.state.mains.safeStock
                           })(
                        ...
                        <FormItem
                         ...
                         >
                           {getFieldDecorator('replenishStockPoint', {
                             ...
                             initialValue:this.state.mains.replenishStockPoint
                           })(
                        ...
                        <FormItem
                         ...
                         >
                           {getFieldDecorator('minSalesStock', {
                             ...
                             initialValue:this.state.mains.minSalesStock
                           })(
...
export default Form.create()(connect()(RecordEdit));
