...
class RecordAdd extends Component {
  ...
  componentDidMount(){
    ...
    mains = [];
    subData = [];
    var obj = {name:'产品复制新增',menuKey:'pro-add-record/'+ this.props.match.params.id,key:'pro-add-record'};
        ...
        if (!err) {
          ...
          fetch(globals.url.url+'/product/product/addToDraft', {
            ...
            if(result.code == 0){
              ...
              var objs = {menuKey:'pro-add-record',key:'pro-add-record'};
...
export default Form.create()(connect()(RecordAdd));
