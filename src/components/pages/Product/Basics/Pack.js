...
export default class Card extends React.Component {
    ...
    list = () => {
        ...
        fetch(globals.url.url + '/product/packingUnit/list', {
            method: 'get',
            credentials: 'include'
        })
    ...
    freeze(record) {
        ...
        if (record.freezeStatus == 1) {
            url = globals.url.url + '/product/packingUnit/freeze?id=' + record.id;
        } else {
            url = globals.url.url + '/product/packingUnit/thaw?id=' + record.id;
        }
        fetch(url, {
            method: 'GET',
            credentials: 'include',
    ...
    handleCreate = () => {
        ...
        form.validateFields((err, values) => {
            ...
            if (DataType.type == 'add') {
                url = '/product/packingUnit/add';
            } else {
                url = '/product/packingUnit/update';
            }
