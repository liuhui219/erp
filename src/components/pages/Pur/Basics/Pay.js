...
export default class Card extends React.Component {
    ...
    list = () => {
        ...
        fetch(globals.url.url + '/fin/pay/list', {
            method: 'get',
            credentials: 'include'
        })
    ...
    freeze(record) {
        ...
        if(record.freezeStatus == 1){
            url = globals.url.url + '/fin/pay/updateDisable?id=' + record.id;
        }else{
            url = globals.url.url + '/fin/pay/updateEnable?id=' + record.id;
        }
        fetch(url, {
            method: 'GET',
            credentials: 'include',
    ...
    render() {
        ...
        const columns = [
            ...
            { title: '付款条件', dataIndex: 'name', width: 150, key: 'name' },
