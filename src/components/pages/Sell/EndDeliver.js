...
class WaitSure extends Component {
  ...
  getData(page,num){
    var that = this;
    fetch(globals.url.url+'/sale/outstock/listOnComplete?pageNumber='+page+'&pageSize='+num, {
      method: 'GET',
      credentials: 'include'
...
toQueryString(obj) {
  ...
  reloads(id){
    this.props.history.push({pathname: '/erp/sale-logistics-EndDeliverInfo/' +id});
    var obj = {name:'已完成出货单详情',menuKey:'sale-logistics-EndDeliverInfo/'+ id,key:'sale-logistics-EndDeliverInfo'};
