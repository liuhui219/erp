...
var mains = [];
var subData = [];
class WaitdeliveryEdit extends Component {
  constructor() {
    super();
    this.state={
      tip:'加载中...',
  ...
  close = (e) => {
    this.props.history.push({pathname: '/erp/sale-WaitdeliveryInfo/' +this.props.match.params.id});
    var obj = {name:'出货通知单详情',menuKey:'sale-WaitdeliveryInfo/'+ this.props.match.params.id,key:'sale-WaitdeliveryInfo'};
    this.props.dispatch({ type: 'INCREMENT' ,text:obj});
    var objs = {menuKey:'sale-WaitdeliveryEdit',key:'sale-WaitdeliveryEdit'};
  ...
  handleSubmit = (e) => {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        fetch(globals.url.url+'/sale/outstock/updateNotify', {
          method: 'POST',
          credentials: 'include',
          headers: {
            'Content-Type': 'application/JSON'
          ...
          if(result.code == 0){
             ...
             that.props.history.push({pathname: '/erp/sale-WaitdeliveryInfo/' +that.props.match.params.id});
             var obj = {name:'出货通知单详情',menuKey:'sale-WaitdeliveryInfo/'+ that.props.match.params.id,key:'sale-WaitdeliveryInfo'};
                     ...
                     <FormItem
                      ...
                      >
                        {getFieldDecorator('carNumber', {
                          ...
                          initialValue:this.state.mains.truckNumber
                        })(
                     ...
                     <FormItem
                      ...
                      >
                        {getFieldDecorator('containerNumber', {
                          ...
                          initialValue:this.state.mains.containerNumber
                        })(
                     ...
                     <FormItem
                      ...
                      >
                        {getFieldDecorator('sealNumber', {
                          ...
                          initialValue:this.state.mains.sealNumber
                        })(
...
export default Form.create()(connect()(WaitdeliveryEdit));
