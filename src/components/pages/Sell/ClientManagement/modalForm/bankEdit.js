...
const TabPane = Tabs.TabPane;
 ...
 handleChange = (e) => {
  ...
  render() {
    ...
    const ClientA = this.props.ClientA; 
    console.log(ClientA)
                  ...
                  <div className="page_add_input_main_form" style={{ width: '28%' }}>
                      ...
                      >
                          {getFieldDecorator('bankId', {
                              ...
                              initialValue: ClientA.informationVO.bankId?ClientA.informationVO.bankId:null                                             
                              
                            //   ClientA.informationVO.bankName
                          })(
                      ...
                      >
                          {getFieldDecorator('bankAccount', {
                              ...
                              initialValue: ClientA.informationVO.bankAccount?ClientA.informationVO.bankAccount:null     
                          })(
                      ...
                      >
                          {getFieldDecorator('accountName', {
                              ...
                              initialValue: ClientA.informationVO.accountName?ClientA.informationVO.accountName:null     
                      ...
                      >
                          {getFieldDecorator('currencyId', {
                              ...
                              initialValue: ClientA.informationVO.currencyId?ClientA.informationVO.currencyId:null     
                  ...
                  <div className="page_add_input_main_form" style={{ width: '35%' }}>
                      ...
                      >
                          {getFieldDecorator('ticketHead', {
                              ...
                              initialValue: ClientA.informationVO.ticketHead?ClientA.informationVO.ticketHead:null     
                      ...
                      >
                          {getFieldDecorator('openingBank', {
                              ...
                              initialValue: ClientA.informationVO.openingBank?ClientA.informationVO.openingBank:null     
                      ...
                      >
                          {getFieldDecorator('openingNumber', {
                              ...
                              initialValue: ClientA.informationVO.openingNumber?ClientA.informationVO.openingNumber:null     
                      ...
                      >
                          {getFieldDecorator('identificationNumber', {
                              ...
                              initialValue: ClientA.informationVO.identificationNumber?ClientA.informationVO.identificationNumber:null     
                  ...
                  <div className="page_add_input_main_form" style={{ width: '37%' }}>
                      ...
                      >
                          {getFieldDecorator('settleWayId', {
                              ...
                              initialValue: ClientA.informationVO.settleWayId?ClientA.informationVO.settleWayId:null     
                      ...
                      >
                          {getFieldDecorator('receiveWayId',{
                              initialValue: ClientA.informationVO.receiveWayId?ClientA.informationVO.receiveWayId:null     
