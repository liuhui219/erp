...
import BankEdit from './modalForm/bankEdit';
    ...
    submitEdit = (e) => {
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                ...
                fetch(globals.url.url + '/sale/customer/update', {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
            ...
            <div>
                <div className="w_content ">
                    <Spin size="large" tip={this.state.tip} spinning={this.state.spinning}>
                        <Form className="page_from" style={{ width: '100%' }} onSubmit={this.submitEdit}>
                                ...
                                <div className="page_add_input_main_form" style={{ width: '28%' }}>
                                    ...
                                    >
                                        {getFieldDecorator('type', {
                                            ...
                                            initialValue: JSON.stringify(this.state.ClientA.type)
                                        })(
                                    ...
                                    >
                                        {getFieldDecorator('salesmanId', {
                                            ...
                                            initialValue: this.state.ClientA.salesmanId
                                        })(
                                            // salesmanList
                                ...
                                <div className="page_add_input_main_form" style={{ width: '35%' }}>
                                    ...
                                    >
                                        {getFieldDecorator('name', {
                                            ...
                                            initialValue: this.state.ClientA.name
                                        })(
                                    ...
                                    >
                                        {getFieldDecorator('customerRankId', {
                                            ...
                                            initialValue:this.state.ClientA.customerRankId? this.state.ClientA.customerRankId :null                                        
                                        })(
                                    ...
                                    >
                                        {getFieldDecorator('currencyId', {
                                            ...
                                            initialValue: this.state.ClientA.currencyId?this.state.ClientA.currencyId:null                                                                                       
                                        })(
                                            // currencyList
                                ...
                                <div className="page_add_input_main_form" style={{ width: '37%' }}>
                                    ...
                                    >
                                        {getFieldDecorator('simpleName', {
                                            ...
                                            initialValue: this.state.ClientA.simpleName                                                                                       
                                    ...
                                    >
                                        {getFieldDecorator('businessAreaId',{
                                            initialValue: this.state.ClientA.businessAreaId?this.state.ClientA.businessAreaId:null                                            
                                        })(
                                    ...
                                    >
                                        {getFieldDecorator('taxRateId',{
                                            initialValue: this.state.ClientA.taxRateId?this.state.ClientA.taxRateId:null                                             
                                        })(
                    ...
                    <div className="page_add_tabs">
                        ...
                        <Tabs defaultActiveKey="1" tabBarStyle={{ border: 'none' }} onChange={this.tabCallback.bind(this)}>
                            ...
                            <TabPane tab="财务信息" key="3">
                                <BankEdit data={this.state.data} ClientA={this.state.ClientA} information = {this.information} ref="bank" />
