...
class History extends Component {
  ...
  getData(page,num){
    var that = this;
    fetch(globals.url.url+'/sale/truck/listOut?pageNumber='+page+'&pageSize='+num, {
      method: 'GET',
      credentials: 'include'
...
toQueryString(obj) {
  ...
  delete(id){
    ...
    var obj = {name:'出货放行',menuKey:'sale-OutFactory/'+ id,key:'sale-OutFactory'};
    this.props.dispatch({ type: 'INCREMENT' ,text:obj});
  }

  reloads(id){
    this.props.history.push({pathname: '/erp/sale-HistoryInfo/' +id});
    var obj = {name:'记录详情',menuKey:'sale-HistoryInfo/'+ id,key:'sale-HistoryInfo'};
    this.props.dispatch({ type: 'INCREMENT' ,text:obj});
  }
