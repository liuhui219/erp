...
var mains = [];
var subData = [];
class OrderDraftInfo extends Component {
  constructor() {
    super();
    this.state={
      tip:'加载中...',
  ...
  handleOks = () =>{
    ...
    fetch(globals.url.url+'/sale/orderDraft/delete', {
      ...
      if(result.code == 0){
         ...
         that.props.history.push({pathname: '/erp/sale-order-draft'});
         var obj = {name:'订单草稿',menuKey:'sale-order-draft',key:'sale-order-draft'};
         that.props.dispatch({ type: 'INCREMENT' ,text:obj});
         var objs = {menuKey:'sale-OrderDraftInfo',key:'sale-OrderDraftInfo'};
...
export default Form.create()(connect()(OrderDraftInfo));
