      ...
      if (!err) {
        ...
        fetch(globals.url.url+'/sale/orderDraft/add', {
          ...
          if(result.code == 0){
            ...
            var obj = {name:'订单草稿',menuKey:'sale-order-draft',key:'sale-ordesale-order-draft'};
  ...
  save = (e) => {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        fetch(globals.url.url+'/sale/order/add', {
          method: 'POST',
          credentials: 'include',
          headers: {
            'Content-Type': 'application/json'
                 ...
                 <div className="page_add_input_main_form" style={{width:'37%'}}>
                     <FormItem
                      ...
                      {getFieldDecorator('currencyId', {
                        ...
                        initialValue:this.state.currencyList[0].name
                      })(
...
export default Form.create()(connect()(AddOrder));
