...
var mains = [];
var subData = [];
class OrderListInfo extends Component {
  constructor() {
    super();
    this.state={
      tip:'加载中...',
  ...
  componentDidMount(){
    this.getData();
    this.getSelect();
    this.props.history.push({pathname: '/erp/sale-OrderListInfo/' +this.props.match.params.id});
    var obj = {name:'销售详情',menuKey:'sale-OrderListInfo/'+ this.props.match.params.id,key:'sale-OrderListInfo'};
...
export default Form.create()(connect()(OrderListInfo));
