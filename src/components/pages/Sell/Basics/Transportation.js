...
export default class Card extends React.Component {
    ...
    list = () => {
        ...
        fetch(globals.url.url + '/sale/deliveryWay/list', {
            method: 'get',
            credentials: 'include'
        })
    ...
    freeze(record) {
        ...
        if(record.freezeStatus == 1){
            url = globals.url.url + '/sale/deliveryWay/freeze?id=' + record.id;
        }else{
            url = globals.url.url + '/sale/deliveryWay/thaw?id=' + record.id;
        }
        fetch(url, {
            method: 'GET',
            credentials: 'include',
    ...
    handleCreate = () => {
        ...
        form.validateFields((err, values) => {
            ...
            if (DataType.type == 'add') {
                url = '/sale/deliveryWay/add';
            } else {
                url = '/sale/deliveryWay/update';
            }
    ...
    render() {
        ...
        const columns = [
            ...
            { title: '交货方式', dataIndex: 'deliveryWay', width: 150, key: 'deliveryWay' },
