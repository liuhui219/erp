...
export default class Card extends React.Component {
    ...
    list = () => {
        ...
        fetch(globals.url.url + '/sale/clientsRank/list', {
            method: 'get',
            credentials: 'include'
        })
    ...
    freeze(record) {
        ...
        if(record.freezeStatus == 1){
            url = globals.url.url + '/sale/clientsRank/freeze?id=' + record.id;
        }else{
            url = globals.url.url + '/sale/clientsRank/thaw?id=' + record.id;
        }
        fetch(url, {
            method: 'GET',
            credentials: 'include',
    ...
    handleCreate = () => {
        ...
        form.validateFields((err, values) => {
            ...
            if (DataType.type == 'add') {
                url = '/sale/clientsRank/add';
            } else {
                url = '/sale/clientsRank/update';
            }
    ...
    render() {
        ...
        const columns = [
            ...
            { title: '客户级别', dataIndex: 'customerRank', width: 150, key: 'customerRank' },
