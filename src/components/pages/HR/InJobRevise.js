...
class InJobRevise extends Component {
  constructor() {
    super();
    this.state={
      loading: false,
  ...
  getAll(){
    var that = this;
    fetch(globals.url.url+'/hr/employee/showPass?id='+this.props.match.params.id, {
      method: 'GET',
      credentials: 'include'
      ...
      if(result.code == 0){
        that.setState({
          ...
          headResourceKey:result.result.headResourceKey
        })
      }else{
   ...
   if(this.state.headResourceKey == ''){
     ...
     this.props.form.validateFields((err, values) => {
       if (!err) {
         ...
         that.state.departmentTypeList.map((data,i)=>{
           if(data.name == values.departmentId){
             values.departmentId = data.id
           }
         })

         that.state.positionTypeList.map((data,i)=>{
           if(data.postName == values.positionId){
             values.positionId = data.id
           }
         })

         that.state.educationTypeList.map((data,i)=>{
           if(data.name == values.educationTypeList){
             values.educationTypeList = data.id
           }
         })
 ...
 send(obj){
   var that = this;
   fetch(globals.url.url+'/hr/employee/updateEmplPass', {
     method: 'POST',
     credentials: 'include',
     headers: {
     ...
     if(result.code == 0){
       ...
       that.props.history.push({pathname: '/erp/hr-entryjob-InJobInfo/' + that.props.match.params.id});
       var obj = {name:'入职详情',menuKey:'hr-entryjob-InJobInfo/'+ that.props.match.params.id,key:'hr-entryjob-InJobInfo'};
       that.props.dispatch({ type: 'INCREMENT' ,text:obj});
       var objs = {menuKey:'hr-entryjob-inJobRevise',key:'hr-entryjob-inJobRevise'};
 ...
 check = (rule, value, callback) => {
  ...
  cancel(){
    this.props.history.push({pathname: '/erp/hr-entryjob-InJobInfo/' + this.props.match.params.id});
    var obj = {name:'驳回详情-'+this.state.dataAll.name,menuKey:'hr-entryjob-InJobInfo/'+ this.props.match.params.id,key:'hr-entryjob-InJobInfo'};
    this.props.dispatch({ type: 'INCREMENT' ,text:obj});
    var objs = {menuKey:'hr-entryjob-inJobRevise',key:'hr-entryjob-inJobRevise'};
  ...
  render() {
    ...
    const prefixSelector = getFieldDecorator('prefix', {
      initialValue: this.state.dataAll.employeeTypeName,
    })(
    ...
    const prefixSelectors = getFieldDecorator('prefixs', {
      initialValue: this.state.dataAll.papersTypeName,
    })(
      <Select disabled style={{ width: 95 }}>
                   ...
                   <div className="page_add_input_main_form" style={{width:'28%'}}>
                       ...
                       <FormItem
                        ...
                        >
                          {getFieldDecorator('name', {
                            ...
                            initialValue:this.state.dataAll.name
                          })(
                       ...
                       <FormItem
                        ...
                        {getFieldDecorator('radio',{
                          ...
                          initialValue:String(this.state.dataAll.sex)
                        })(
                            <RadioGroup>
                       ...
                       <FormItem
                        ...
                        >
                          {getFieldDecorator('birthday', {
                            ...
                            initialValue:moment(this.state.dataAll.birthday)
                          })(
                            <DatePicker disabled placeholder="选择出生日期"/>
                          )}
                       </FormItem>
                       <FormItem
                          {...formItemLayout}
                        ...
                        >
                          {getFieldDecorator('nativePlace', {
                            ...
                            initialValue:this.state.dataAll.nativePlace
                          })(
                   ...
                   <div className="page_add_input_main_form" style={{width:'35%'}}>
                       <FormItem
                        ...
                        >
                          {getFieldDecorator('hiredate', {
                            ...
                            initialValue:moment(this.state.dataAll.hiredate)
                          })(
                       ...
                       <FormItem
                        ...
                        >
                          {getFieldDecorator('phoneNumber', {
                            ...
                            initialValue:this.state.dataAll.phoneNumber
                          })(
                       ...
                       <FormItem
                        ...
                        {getFieldDecorator('departmentId', {
                          ...
                          initialValue:this.state.dataAll.departmentName
                        })(
                       ...
                       <FormItem
                        ...
                        {getFieldDecorator('positionId', {
                          ...
                          initialValue:this.state.dataAll.postionName
                        })(
                       ...
                       <FormItem
                        ...
                        >
                          {getFieldDecorator('school', {
                            ...
                            initialValue: { school: this.state.dataAll.school, subject: this.state.dataAll.professional },
                          })(
                            <PriceInput />
                          )}
                       </FormItem>
                       <FormItem
                        ...
                        >
                          {getFieldDecorator('educationTypeList', {
                            ...
                            initialValue:this.state.dataAll.educationName
                          })(
                   ...
                   <div className="page_add_input_main_form" style={{width:'37%'}}>
                       ...
                       <FormItem
                        ...
                        >
                          {getFieldDecorator('email', {
                            ...
                            initialValue:this.state.dataAll.email
                          })(
                       ...
                       <FormItem
                        ...
                        >
                          {getFieldDecorator('wechat', {
                            ...
                            initialValue:this.state.dataAll.wechat
                          })(
                       ...
                       <FormItem
                        ...
                        {getFieldDecorator('employeeId', {
                          ...
                          initialValue:this.state.dataAll.number
                        })(
                       ...
                       <FormItem
                        ...
                        >
                          {getFieldDecorator('papersId', {
                            ...
                            initialValue:this.state.dataAll.papersNumber
                          })(
                            <Input disabled addonBefore={prefixSelectors} style={{ width: '100%' }} />
                          )}
                       </FormItem>
                       <FormItem
                          {...formItemLayout}
                        ...
                        >
                          {getFieldDecorator('address', {
                            ...
                            initialValue:this.state.dataAll.address
                          })(
...
export default Form.create()(connect()(InJobRevise));
