...
export default class Nation extends React.Component {
    ...
    // 删除
    delete= (id) =>  {
        this.save('','/hr/ethnicType/delete?id='+id)
    }   
    // 获取列表
    list = () => {
        let that = this;
        let data = that.state.data;
        fetch(globals.url.url + '/hr/ethnicType/list', {
            method: 'get',
            credentials: 'include',
        })
    ...
    handleCancel = () => {
        ...
        form.validateFields((err, values) => {
            ...
            if(DataType.type == 'add'){
                url = '/hr/ethnicType/add';
            }else{
                url = '/hr/ethnicType/update';                
            }
    ...
    render() {
        ...
        const columns = [
            ...
            { title: '民族', dataIndex: 'name', width: 250, key: 'name' },
