...
export default class Nationality extends React.Component {
    ...
    // 删除
    delete = (id) => {
        this.save('', '/hr/nationType/delete?id=' + id)
    }
    // 获取列表
    list = () => {
        let that = this;
        let data = that.state.data;
        fetch(globals.url.url + '/hr/nationType/list', {
            method: 'get',
            credentials: 'include',
        })
    ...
    handleCancel = () => {
        ...
        form.validateFields((err, values) => {
            ...
            if (DataType.type == 'add') {
                url = '/hr/nationType/add';
            } else {
                url = '/hr/nationType/update';
            }
    ...
    render() {
        ...
        const columns = [
            ...
            { title: '国籍', dataIndex: 'name', width: 250, key: 'name' },
