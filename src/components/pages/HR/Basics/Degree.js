...
export default class Degree extends React.Component {
    ...
    // 删除
    delete= (id) =>  {
        this.save('','/hr/degreeType/delete?id='+id)
    }   
    // 获取列表
    list = () => {
        let that = this;
        let data = that.state.data;
        fetch(globals.url.url + '/hr/degreeType/list', {
            method: 'get',
            credentials: 'include',
        })
    ...
    handleCancel = () => {
        ...
        form.validateFields((err, values) => {
            ...
            if(DataType.type == 'add'){
                url = '/hr/degreeType/add';
            }else{
                url = '/hr/degreeType/update';                
            }
    ...
    render() {
        ...
        const columns = [
            ...
            { title: '学位', dataIndex: 'name', width: 150, key: 'name' },
