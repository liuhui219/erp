...
class StaffCheckInfo extends Component {
  constructor() {
    super();
    this.state={
      data:{},
  ...
  handleOk(){
    ...
    fetch(globals.url.url+'/hr/employee/updateReject', {
      ...
      if(result.code == 0){
         ...
         var obj = {menuKey:'hr-entryjob-info',key:'hr-entryjob-info'};
  ...
  sure(){
    ...
    fetch(globals.url.url+'/hr/employee/updatePass', {
      method: 'POST',
      credentials: 'include',
      headers: {
        'Content-Type': 'application/x-www-form-urlencoded'
          ...
          <div className='page_add_input' style={{padding:20}}>
              <div className="page_info">
                 ...
                 <div className="page_add_input_btn_right">
                     <Button onClick={this.cancel.bind(this)} type="primary" icon="dvt-salesOrder">
                       驳回
                     </Button>
                     <Button onClick={this.sure.bind(this)}  style={{marginLeft:15}} type="primary" icon="close-square-o">
                       同意
                     </Button>
                 </div>
              </div>
...
export default connect()(StaffCheckInfo);
